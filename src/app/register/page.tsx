...
function RegisterForm() {
  ...
  const specialties = [
    ...
    'Çocuk Anesteziyolojisi',
    'Çocuk Radyolojisi',
    'Çocuk Patolojisi',
    'Çocuk Mikrobiyolojisi',
    'Çocuk Biyokimyası',
    'Çocuk Genetik',
    'Çocuk Nükleer Tıp',
    'Çocuk Radyasyon Onkolojisi',
    'Çocuk Tıbbi Genetik',
    'Çocuk Tıbbi Onkolojisi',
    'Çocuk Adli Tıp',
    'Çocuk Halk Sağlığı',
    'Çocuk Spor Hekimliği',
    'Çocuk Aile Hekimliği',
    'Çocuk Geriatri',
    'Çocuk Beslenme ve Diyet',
    'Çocuk Fizyoterapi',
    'Çocuk Psikoloji',
    'Çocuk Hemşireliği',
    'Çocuk Eczacılığı',
    'Çocuk Diş Hekimliği',
    'Çocuk Veteriner Hekimliği',
    'Diğer'
  ];
