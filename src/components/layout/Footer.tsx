        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              Uzmanlarla bağlantı kurun, sorularınızı sorun ve sağlıklı yaşamı destekleyin.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex space-x-6">
              ...
              <Link href="/gizlilik-politikasi" className="text-gray-500 hover:text-blue-600 text-sm transition-colors">
                Gizlilik Politikası
              </Link>
              <Link href="/cerez-politikasi" className="text-gray-500 hover:text-blue-600 text-sm transition-colors">
                Çerez Politikası
              </Link>
            </div>
          </div>
